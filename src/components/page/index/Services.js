  ...
  return (
    <>
      <div className="text-center mb-24">
        <h3 className="text-primary text-3xl  mb-1">Comment obtenir plus de clients ?</h3>
        <p>
          <span className="text-primary">WWOM</span> améliore le bouche à oreille de votre business
          !
        </p>
      </div>
      <div>
      ...
      <div className="flex justify-center mt-20">
        <ButtonLink content="Découvrez WWOM" />
      </div>
    </>
  );
};
